...
export default function ProfilePage() {
  ...
  return (
    <div className="flex h-screen bg-[#241c15] text-[#f0d9b5] font-sans overflow-hidden">
      ...
      {/* --- MINIMAL SIDEBAR (Copied from HomePage for consistency) --- */}
      <aside className="w-20 lg:w-24 bg-[#1a140f] hidden md:flex flex-col items-center py-6 border-r border-[#3d2b1f] z-10 shadow-2xl">
        ...
        <nav className="flex flex-col gap-6 w-full px-2">
          ...
          <Link to="/profile" className="group flex flex-col items-center gap-1 text-[#d4700a] transition-colors">
            <div className="bg-[#3d2b1f] p-3 rounded-xl border border-[#d4700a]">👤</div>
