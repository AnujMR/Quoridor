...
const LoginPage: React.FC = () => {
  ...
  const handleGoogleSignIn = async () => {
    try {
      ...
      // Redirect to the game board after successful login
      navigate('/board'); 
    } catch (err: any) {
  ...
  return (
    <div className="min-h-screen bg-gray-900 flex items-center justify-center p-4">
      <div className="max-w-md w-full bg-gray-800 rounded-xl shadow-lg p-8 space-y-6 border border-gray-700">
        
        {/* Header */}
        <div className="text-center">
          <h1 className="text-4xl font-extrabold text-white mb-2">Quoridor</h1>
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 bg-white text-gray-900 font-semibold py-3 px-4 rounded-lg transition-transform hover:-translate-y-0.5 hover:shadow-md active:translate-y-0"
        >
